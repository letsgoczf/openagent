    ...
    def retrieve(
        ...
        *,
        ...
        effective_version_scope = (
            self._sqlite.list_retrievable_version_ids()
        ...
        if not effective_version_scope:
            return RetrievalResult(
                ...
                retrieval_state={
                    ...
                    "version_scope_source": "default_retrievable"
                    if version_scope is None
                    else "explicit",
                },
        ...
        state = {
            ...
            "version_scope_source": "default_retrievable" if version_scope is None else "explicit",
        }
        if kw_error:
