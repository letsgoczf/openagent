...
class RetrievalService:
    ...
    def retrieve(
        ...
        *,
        ...
        effective_version_scope = version_scope
        version_scope_source = "explicit"
        if effective_version_scope is None:
            effective_version_scope = self._sqlite.list_retrievable_version_ids()
            version_scope_source = "retrievable_status"
        if not effective_version_scope:
            return RetrievalResult(
                ...
                candidate_debug={"dense_hits": [], "keyword_hits": [], "merged": []}
                if candidate_debug
                else None,
            )
        ...
        state = {
            ...
            "rag_views": None,
            "version_scope_source": version_scope_source,
            "version_scope_count": len(effective_version_scope),
        }
        if kw_error:
