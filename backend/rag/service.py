    ...
    def retrieve(
        ...
        *,
        ...
        if not effective_version_scope:
            return RetrievalResult(
                ...
                retrieval_state={
                    ...
                    "evidence_entries": 0,
                    "citations": 0,
                    "retrievable_versions": 0,
                    "version_scope_requested": len(version_scope) if version_scope is not None else None,
                },
        ...
        state = {
            ...
            "allowed_origin_types": origin_list,
            "rag_views": None,
            "retrievable_versions": len(effective_version_scope),
            "version_scope_requested": len(version_scope) if version_scope is not None else None,
        }
        if kw_error:
